...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dim', type=int, default=3, metavar='id',
                        help='input dimemtion (default: 3)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='od',
                        help='output dimemtion (default: 1)')
    parser.add_argument('--hidden_dim', type=int, default=64, metavar='hd',
                        help='hiddendim dimemtion (default: 64)')   
